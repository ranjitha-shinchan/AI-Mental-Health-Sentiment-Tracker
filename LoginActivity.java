...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ForgotPass.setOnClickListener(view -> intentNow(ResetPassword.class)); //To Forgot Password (Reset Password Activity)

        LoginButton.setOnClickListener(view -> {
            if (isConnected()) Login();
        });  //Login Button CTA

        SignUp.setOnClickListener(view -> intentNow(Register.class)); //To SignUp Activity
